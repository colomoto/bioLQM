...
/**
 * Updater for the asynchronous scheme: all possible changes are applied
 * separately. It returns all successors according to the order of components in
 * the model.
 * 
